          ...
          <div className="space-y-8 relative">
             {modules.map((module, index) => {
                 ...
                 return (
                     ...
                     >
                        {/* Icon Node */}
                        <div className={`relative z-10 w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center shrink-0 border-4 transition-all ${
                        ...
                        <div className={`flex-1 p-6 rounded-3xl border transition-all ${
                            isCurrent ? 'bg-white dark:bg-slate-900 border-indigo-200 dark:border-indigo-900 shadow-lg' :
